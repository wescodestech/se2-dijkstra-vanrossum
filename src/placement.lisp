...
(defun place (brd word type coord)
  (let* ((column (car coord))
         (row    (cadr coord)))
        ; Right placement
    (cond ((= type 0) (replace-characters word brd column row "right"))
          
          ; Left placement
          ((= type 1) (replace-characters word brd column row "left"))
          
          ; Down placement
          ((= type 2) (replace-characters word brd column row "down"))
          
          ; Up placement
          ((= type 3) (replace-characters word brd column row "up"))
          
          ; Right-Down placement
          ((= type 4) (replace-characters word brd column row "right-down"))
          
          ; Left-Down placement
          ((= type 5) (replace-characters word brd column row "left-down"))
          
          ; Right-Up placement
          ((= type 6) (replace-characters word brd column row "right-up"))
          
          ; Left-Up placement
          ((= type 7) (replace-characters word brd column row "left-up")))))
